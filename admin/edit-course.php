     ...
     if (isset($_POST['sub'])) {
        $crud->updateCourse($_POST);
        }

    $tb=$crud->displayById('course',$_GET['id']);
                                    ...
                                    <div class="basic-form">
                                      ...
                                      <form action="edit-course.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="name" value="<?php  echo $tb['name'];?>" placeholder="Please enter Course name" required="required">
