     			...
     			<div class="wrap-login100">
     				<form action="application-check.php" class="login100-form validate-form" method="post">
     					...
     					<span class="login100-form-title p-b-5">
     						<p style="color: blue;opacity: .5;font-size: 20px;margin-top: -150px;"> <marquee behavior="alternate" scrollDelay="10">CENTRALIZED TRANSCRIPT SYSTEM</marquee></p>
     						<br><br><br><br>
     					...
     					<div class="wrap-input100 validate-input" data-validate = "Matriculation Number is required">
     						<input class="input100" type="text" name="matno" placeholder="Matriculation Number" required  />
